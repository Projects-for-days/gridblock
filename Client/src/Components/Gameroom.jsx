        ...
        if (idx !== -1) {
            ...
            return (
                <div className = "gameroom">
                    ...
                    <div style={{marginTop: 12}}>
                        <div><b>Lines:</b>{lines}/5</div>
                        {winner && <div style= {{marginTop: 8, fontWeight: "bold"}}> YOU WIN!</div>}
                    </div>
                    <Board
                        size={size}
                        board={board}
                    ...
                    <div style={{marginTop: 16}}>
                        ...
                        <div style={{lineHeight: 1.8}}>
                            {calledNumbers.lenght === 0 ? "None yet": [...calledNUmbers].join(",")}                            
                        </div>
                    </div>
                </div>
            );
